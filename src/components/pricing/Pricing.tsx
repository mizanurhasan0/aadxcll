  ...
  if (isLoading) {
    return <HeaderPricing>
      <div className="flex justify-center items-center py-20">
        ...
        <span className="ml-3 text-textmuted">Loading pricing plans...</span>
      </div>
    </HeaderPricing>
  }
    ...
    <HeaderPricing>
      ...
      {hasMore && (
        <div className="mt-10 text-center">
          <Link href="/pricing" className="inline-block px-6 py-3 bg-gray-100 hover:bg-gray-200 text-textmuted rounded-lg transition-colors">See more</Link>
        </div>
      )}
    </HeaderPricing>
  );
