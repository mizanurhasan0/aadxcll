...
const stats = [
  ...
  { number: 1000, label: 'Honorable Clients', icon: '🤝' },
  { number: 25, label: 'Professional Expertise', icon: '👨🏾‍🤝‍👨🏼' },
  { number: 97, label: 'Success Ratio', icon: '🏆', type: '%' }
];
    ...
    <section ref={sectionRef} className="py-20 bg-gray-900 text-white">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center mb-16">
          <p className=" font-semibold mb-4 text-primary underline underline-offset-8"> Short Study</p>
          ...
          {stats.map((stat, idx) => (
            <div key={idx} className="bg-gray-800 rounded-xl p-6 text-center border border-gray-700 shadow-lg">
              ...
              <div className="text-5xl font-bold mb-3 text-primary">
                {counts[idx]}{stat.type ? stat.type : '+'}
              </div>
