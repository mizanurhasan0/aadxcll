  ...
  <section className="py-20 bg-gray-50">
    <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div className="flex justify-center">
        <div className="w-96 h-96 bg-blue-100 rounded-full flex items-center justify-center overflow-hidden">
          <img src="/projects/about-baner-1.jpeg" alt="Second Hero" className="w-full h-full object-cover" />
        </div>
      </div>
