...
const Hero = () => {
  ...
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center pt-20 bg-black overflow-hidden">
      {particlesReady && (
        <Particles
          id="tsparticles"
        ...
        <Slider {...sliderSettings}>
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex justify-center">
                <img src="https://via.placeholder.com/500x400" alt="Creative IT" className="rounded-lg shadow-lg max-w-full" />
              </div>
            </div>
          </div>
        </Slider>
