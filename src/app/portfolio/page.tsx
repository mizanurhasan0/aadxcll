...
export default function PortfolioPage() {
    ...
    if (isLoading) {
        return (
            <div className="min-h-screen bg-bg py-40">
                <div className="max-w-6xl mx-auto px-4">
                    <div className="text-center">
                        <h1 className="text-4xl font-bold text-text mb-8">Portfolio</h1>
        ...
        <div className="min-h-screen bg-bg py-40">
            <div className="max-w-6xl mx-auto px-4">
                <div className="text-center mb-16">
                    <h1 className="text-4xl font-bold text-text mb-4">Portfolio</h1>
                        ...
                        {categories.map((category) => (
                            <button
                                ...
                                className={`px-6 py-2 rounded-full transition-colors ${activeCategory === category
                                    ...
                                    : 'bg-bg-card text-text-muted hover:bg-gray-100 shadow-sm'
                                    }`}
                            >
                                {category}
                            </button>
                ...
                {visibleProjects.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-text-muted mb-2">No projects found in this category</p>
